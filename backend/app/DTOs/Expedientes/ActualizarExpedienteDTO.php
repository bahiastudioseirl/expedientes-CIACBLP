...
class ActualizarExpedienteDTO
{
    public function __construct(
        ...
        public int $id_usuario // Usuario que actualiza (del JWT)
    ){}

    public static function fromRequest(array $data, int $id_expediente, int $id_usuario): self
    {
        return new self(
    ...
    public function toExpedienteArray(): array
    {
        return [
