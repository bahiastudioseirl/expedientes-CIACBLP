...
class ActualizarExpedienteRequest extends FormRequest
{
    ...
    {
        $expedienteId = $this->route('id'); // Obtener el ID del expediente de la ruta
        
        return [
            'codigo_expediente' => "required|string|max:255|unique:expedientes,codigo_expediente,{$expedienteId},id_expediente",
